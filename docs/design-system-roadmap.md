...
| 5 | **W3c** | W | Интерактивность шкалы: клик по дню = прыжок скролла, follow-дата под курсором, drag диапазона на рейке | в работе (change `refine-event-timeline-scale-w3c`) |
