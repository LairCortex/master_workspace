...
| 3 | **W3** | W | Визуальная шкала событий (дорожки), не `QListWidget`. Widgets + токены W1 | реализован, ждёт коммита/мерджа (change `add-event-timeline-tracks-w3`, коммитов ещё нет; зум/drag/дорожки-по-сущностям — вне карты, зафиксировано ниже) |
