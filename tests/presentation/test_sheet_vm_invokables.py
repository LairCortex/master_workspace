...
DESIGN_REQUIRED_SIGNATURES = [
    ...
    "commit_drag(QString,double,double,double,double)",
    "open_inline(QString)",
    "commit_inline()",
    "cancel_inline()",
    "undo()",
    ...
    "remove_selection()",
    "commit_drag_selection(double,double,double,double)",
    "commit_drag_selection(double,double,double,double,QVariant)",
